...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝ ╚═╝  ╚═╝ ╚═════╝
        ...
        self.LOGGER(__name__).info(f"Bot Running..! Made by @Ott_Sandhu")   
        ...
        try: await self.send_message(OWNER_ID, text = f"<b><blockquote>🤖 Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ by @Baii_Ji</blockquote></b>")
        except: pass
